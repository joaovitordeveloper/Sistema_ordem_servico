    ...
    <?php if ($grupo->id < 2): ?>
        <div class="col-md-12">
            <div class="alert alert-info" role="alert">
                ...
                <p>O grupo de <b><?php echo esc($grupo->nome); ?></b> não pode ser editado ou excluido, pois os mesmos não
        ...
        <div class="user-block block">
            ...
            <p class="contributions mt-0"> <?php echo $grupo->exibeSituacao(); ?>
                ...
                <a tabindex="0" style="text-decoration:none;" role="button" data-toggle="popover" data-trigger="focus"
                    title="Importante"
                    data-content="Esse grupo <?php echo ($grupo->exibir == true ? 'será' : 'não será') ?> exibido como opção na hora de definir um <b>Responsavel técnico </b>pela ordem de serviço">&nbsp;&nbsp;<i
            ...
            <div class="btn-group mr-2">
                ...
                <div class="dropdown-menu">
                    ...
                    <a class="dropdown-item"
                        href="<?php echo site_url("grupos/restaurargrupo/$grupo->id"); ?>">Restaurar grupo de acesso</a>
                    <?php endif;?>
